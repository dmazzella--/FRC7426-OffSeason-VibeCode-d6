...
public class TunerConstants {
    ...
    //Max Speed from pheonix tuner TunerConstants.kSpeedAt12Volts.in(MetersPerSecond)
    public static double MaxSpeed = 4.74; // kSpeedAt12Volts desired top speed
    public static double MaxAngularRate = RotationsPerSecond.of(0.75).in(RadiansPerSecond); // 3/4 of a rotation per second max angular velocity

    public static double steerKp = 28.423;
    public static double steerKd = 0.97074;
    public static double driveKp = 0.29469;
    public static double driveKd = 0;

    // The steer motor uses any SwerveModule.SteerRequestType control request with the
    // output type specified by SwerveModuleConstants.SteerMotorClosedLoopOutput
    private static Slot0Configs steerGains = new Slot0Configs()
        .withKP(28.423).withKI(0).withKD(0.97074)
    ...
    private static Slot0Configs driveGains = new Slot0Configs()
        .withKP(0.29469).withKI(0).withKD(0)
        .withKS(0).withKV(0.105)
        .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseClosedLoopSign);
    ...
    private static final TalonFXConfiguration driveInitialConfigs = new TalonFXConfiguration()
        .withCurrentLimits(
            new CurrentLimitsConfigs()
                .withSupplyCurrentLimit(Amps.of(62.5))
                .withSupplyCurrentLimitEnable(true)
                .withStatorCurrentLimit(Amps.of(72.5))
    ...
    // This needs to be tuned to your individual robot
    public static final LinearVelocity kSpeedAt12Volts = MetersPerSecond.of(4.74);
    ...
    // Front Left (Checked (Possible))
    private static final int kFrontLeftDriveMotorId = 3;
    private static final int kFrontLeftSteerMotorId = 7;
    private static final int kFrontLeftEncoderId = 11;
    private static final Angle kFrontLeftEncoderOffset = Rotations.of(-0.270263671875);
    ...
    private static final Angle kBackLeftEncoderOffset = Rotations.of(-0.110107421875);
    ...
    private static final Angle kBackRightEncoderOffset = Rotations.of(-0.056640625);
